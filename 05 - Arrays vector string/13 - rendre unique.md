...
Sans faire usage de `vector::erase`, écrire une fonction C++ qui supprime tout élément égal à l'élément qui les précède dans le `vector`. Avec la fonction `to_string` de l'exercice 09, le programme ci-dessous
